...
<div class="row">
  <div class="col-12">
    <div class="card mb-4">
      <div class="card-header"><strong>Alert</strong></div>
      <div class="card-body">
        <p class="text-body-secondary small">Alert is prepared for any length of text, as well as an optional close button. For a styling, use one of the required contextual <code>color</code> classes (e.g., <code>alert-primary</code>).</p>
    ...
    <div class="card mb-4">
      <div class="card-header"><strong>Alert</strong> <small>Link color</small></div>
      <div class="card-body">
    ...
    <div class="card mb-4">
      <div class="card-header"><strong>Alert</strong> <small>Additional content</small></div>
      <div class="card-body">
        <p class="text-body-secondary small">Alerts can also incorporate supplementary components &amp; elements like heading, paragraph, and divider.</p>
    ...
    <div class="card mb-4">
      <div class="card-header"><strong>Alert</strong> <small>Dismissing</small></div>
      <div class="card-body">
        <p class="text-body-secondary small">Alerts can also be easily dismissed. Just add <code>data-bs-dismiss="alert"</code> to close button.</p>
